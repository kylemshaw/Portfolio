...
namespace TravelExperts.Data.Domain
{
    public partial class TravelExpertsContext : DbContext
    {
        ...
        public virtual DbSet<CustomersPackage> CustomersPackages { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Authentication>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Username, e.Password }, "UC_Auth")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Customer)
                    ...
                    .HasConstraintName("FK_AuthenticationCustomer");
            });
            ...
            modelBuilder.Entity<CustomersPackage>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.CustomersPackages)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
