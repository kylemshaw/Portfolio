...
//     Class: OOSD May 21
// 	   Author: Adolphus Cox
//     Description: Data model class for any Customer Table entries being handled by the application
//----------------------------------------------------------------------------
...
public class Customer implements Serializable {
    ...
    public Customer(int customerId, String custFirstName, String custLastName,
                    ...
                    String custBusPhone, String custEmail, String custPassword, int agentId) {
