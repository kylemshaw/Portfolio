...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2021 at 12:54 AM
...
CREATE TABLE `agents` (
  ...
  `AgtPhoto` varchar(20) DEFAULT NULL,
  `AgtUsername` varchar(50) DEFAULT NULL,
  `AgtPassword` varchar(50) DEFAULT NULL
...
INSERT INTO `agents` (`AgentId`, `AgtFirstName`, `AgtMiddleInitial`, `AgtLastName`, `AgtBusPhone`, `AgtEmail`, `AgtPosition`, `AgencyId`, `AgtPhoto`, `AgtUsername`, `AgtPassword`) VALUES
(1, 'Janet', 'A.', 'Delton', '(403) 210-7801', 'janet.delton@travelexperts.com', 'Senior Agent', 1, 'Janet.jpg', 'JDelton', 'password1'),
(2, 'Judy', 'A.', 'Lisle', '(403) 210-7802', 'judy.lisle@travelexperts.com', 'Intermediate Agent', 1, 'Judy.jpg', 'JLisle', 'password'),
(3, 'Dennis', 'C.', 'Reynolds', '(403) 210-7843', 'dennis.reynolds@travelexperts.com', 'Junior Agent', 1, 'Dennis.jpg', 'DReynolds', 'password'),
(4, 'John', NULL, 'Coville', '(403) 210-7823', 'john.coville@travelexperts.com', 'Intermediate Agent', 1, 'John.jpg', 'JCoville', 'password'),
(5, 'Fred', 'J', 'Smith', '(403) 210-5555', 'fred@travelexperts.com', 'Junior Agent', 2, 'Fred.jpg', NULL, NULL),
(6, 'Bruce', 'J.', 'Dixon', '(403) 210-7867', 'bruce.dixon@travelexperts.com', 'Intermediate Agent', 2, 'Bruce.jpg', 'BDixon', 'password'),
(7, 'Beverly', 'S.', 'Jones', '(403) 210-7812', 'beverly.jones@travelexperts.com', 'Intermediate Agent', 1, 'Beverly.jpg', 'BJones', 'password'),
(8, 'Jane', NULL, 'Merrill', '(403) 210-7868', 'jane.merrill@travelexperts.com', 'Senior Agent', 2, 'Jane.jpg', NULL, NULL),
(9, 'Brian', 'S.', 'Peterson', '(403) 210-7833', 'brian.peterson@travelexperts.com', 'Junior Agent', 2, 'Brian.jpg', 'BPeterson', 'password');
...
CREATE TABLE `bookings` (
  ...
  `TravelerCount` double NOT NULL,
  `CustomerId` int(11) NOT NULL,
  `TripTypeId` varchar(1) DEFAULT NULL,
  `PackageId` int(11) NOT NULL,
  `FeeId` varchar(5) DEFAULT 'BK',
...
INSERT INTO `bookings` (`BookingId`, `BookingDate`, `BookingNo`, `TravelerCount`, `CustomerId`, `TripTypeId`, `PackageId`, `FeeId`, `AgentId`) VALUES
(11, '2016-01-31 00:00:00', 'DFS3', 1, 143, 'B', 3, 'BK', 2),
(15, '2016-03-05 00:00:00', 'WDR898', 1, 135, 'L', 3, 'BK', 9),
(17, '2016-03-06 00:00:00', 'FES3', 1, 143, 'B', 4, 'BK', 3),
(34, '2016-03-24 00:00:00', 'S935', 2, 138, 'G', 1, 'BK', 8),
(46, '2016-03-30 00:00:00', 'SKJ329', 2, 133, 'L', 1, 'BK', 4),
(49, '2016-03-31 00:00:00', 'S943', 2, 114, 'G', 4, 'BK', 6),
(52, '2016-04-01 00:00:00', 'S934', 2, 133, 'B', 2, 'BK', 8),
(55, '2016-04-03 00:00:00', 'SDFJ3982', 2, 133, 'G', 2, 'BK', 7),
(57, '2016-08-08 00:00:00', 'FJKD344', 2, 130, 'L', 3, 'BK', 9),
(62, '2016-11-25 00:00:00', 'SCR39', 2, 130, 'G', 1, 'BK', 9),
(65, '2016-12-17 00:00:00', 'HK777', 1, 143, 'L', 2, 'BK', 5),
(73, '2016-01-27 00:00:00', 'SW34', 1, 143, 'L', 4, 'BK', 3),
(79, '2016-02-12 00:00:00', 'MKI333', 2, 120, 'G', 4, 'BK', 2),
(80, '2016-02-13 00:00:00', 'MKI334', 2, 122, 'L', 3, 'BK', 1),
(84, '2016-02-15 00:00:00', 'KK890', 2, 120, 'B', 1, 'BK', 8),
(89, '2016-03-03 00:00:00', 'DF344', 1, 109, 'L', 2, 'BK', 3),
(98, '2016-03-22 00:00:00', 'JI8787', 1, 143, 'B', 1, 'BK', 4),
(108, '2016-04-04 00:00:00', 'MKI338', 2, 138, 'L', 4, 'BK', NULL),
(124, '2016-04-29 00:00:00', 'SJKDK89', 2, 114, 'G', 2, 'BK', NULL),
(138, '2016-05-28 00:00:00', 'HJK78', 1, 109, 'L', 4, 'BK', NULL),
(141, '2016-06-01 00:00:00', 'KL888', 1, 143, 'B', 1, 'BK', 7),
(148, '2016-06-28 00:00:00', 'LJ888', 2, 133, 'B', 2, 'BK', NULL),
(152, '2016-08-15 00:00:00', 'WS343', 2, 130, 'G', 1, 'BK', NULL),
(156, '2016-09-23 00:00:00', 'JKKO9', 1, 143, 'B', 3, 'BK', 4),
(161, '2016-09-27 00:00:00', 'SG4SD', 1, 105, 'B', 4, 'BK', 3),
(162, '2016-09-28 00:00:00', 'GFRER4', 1, 109, 'B', 1, 'BK', NULL),
(172, '2016-10-03 00:00:00', 'FGFD64', 1, 104, 'L', 1, 'BK', 6),
(187, '2015-01-01 00:00:00', 'ZAQ344', 1, 109, 'B', 3, 'BK', 5),
(199, '2015-01-15 00:00:00', 'JSD39', 1, 143, 'L', 4, 'BK', NULL),
(204, '2015-01-18 00:00:00', 'XVV67', 1, 141, 'L', 2, 'BK', 4),
(220, '1999-01-29 00:00:00', 'BCV5', 1, 127, 'L', 1, 'BK', NULL),
(226, '1999-02-19 00:00:00', 'DS3DF', 1, 143, 'B', 4, 'BK', 3),
(228, '1999-02-20 00:00:00', 'KF83', 1, 119, 'B', 3, 'BK', 2),
(263, '1999-03-17 00:00:00', 'CBB34', 2, 120, 'B', 2, 'BK', 1),
(264, '1999-03-18 00:00:00', 'SDF890', 1, 135, 'L', 1, 'BK', 1),
(266, '1999-03-18 00:00:00', 'AZX24', 2, 135, 'B', 4, 'BK', 3),
(273, '1999-03-21 00:00:00', 'DGG33', 2, 122, 'B', 2, 'BK', 5),
(287, '1999-04-15 00:00:00', '7898797', 1, 141, 'L', 1, 'BK', 8),
(305, '1999-04-21 00:00:00', 'XC2', 1, 127, 'B', 2, 'BK', NULL),
(312, '1999-04-28 00:00:00', 'SDSD33', 1, 130, 'L', 4, 'BK', 8),
(313, '1999-04-29 00:00:00', 'SD46', 1, 120, 'B', 4, 'BK', 8),
(322, '1999-05-27 00:00:00', 'FJSDKL833', 1, 143, 'B', 3, 'BK', 9),
(325, '1999-06-02 00:00:00', 'HJJK77', 1, 121, 'B', 1, 'BK', 8),
(369, '1999-08-18 00:00:00', 'KJ392', 1, 104, 'L', 4, 'BK', 4),
(375, '1999-08-21 00:00:00', 'SDJF382', 1, 104, 'L', 4, 'BK', 3),
(381, '1999-08-23 00:00:00', 'JDKJF8343', 1, 104, 'L', 1, 'BK', 6),
(382, '1999-08-23 00:00:00', 'FDJ93', 1, 119, 'B', 1, 'BK', 4),
(384, '1999-08-24 00:00:00', 'JHJH7', 1, 119, 'L', 2, 'BK', 2),
(409, '1999-09-07 00:00:00', 'FD53767', 2, 139, 'B', 3, 'BK', 6),
(410, '1999-09-07 00:00:00', 'JHK7', 2, 140, 'B', 4, 'BK', 3),
(425, '1999-09-12 00:00:00', 'FG879', 4, 140, 'G', 1, 'BK', 8),
(442, '1999-09-21 00:00:00', 'S53423', 1, 104, 'L', 4, 'BK', 6),
(443, '1999-09-21 00:00:00', 'T345', 1, 119, 'L', 2, 'BK', 7),
(449, '1999-09-23 00:00:00', 'RD4EW5', 1, 140, 'B', 2, 'BK', 4),
(482, '1999-10-03 00:00:00', 'SKFJ32', 1, 127, 'L', 3, 'BK', 3),
(484, '1999-10-04 00:00:00', 'GDEWR3', 1, 106, 'L', 3, 'BK', 5),
(488, '1999-10-05 00:00:00', 'JDFS39', 1, 106, 'B', 4, 'BK', 9),
(489, '1999-10-05 00:00:00', 'SDR54', 1, 127, 'L', 1, 'BK', 9),
(510, '1999-10-19 00:00:00', 'HKK7', 1, 140, 'L', 4, 'BK', 6),
(511, '1999-10-20 00:00:00', 'FJK3892', 1, 141, 'L', 3, 'BK', 9),
(512, '1999-10-20 00:00:00', 'SG444', 1, 141, 'L', 2, 'BK', 2),
(517, '1999-10-21 00:00:00', 'FSDW2', 1, 140, 'L', 1, 'BK', 6),
(529, '1999-10-28 00:00:00', 'FKJD32', 1, 119, 'L', 4, 'BK', 5),
(546, '1999-11-27 00:00:00', 'NKU7', 1, 140, 'B', 3, 'BK', 3),
(553, '1999-11-29 00:00:00', 'KKU7', 1, 109, 'B', 2, 'BK', 7),
(594, '1999-12-06 00:00:00', 'HNN77', 1, 119, 'L', 2, 'BK', 2),
(596, '1999-12-12 00:00:00', 'FDKJ898', 1, 106, 'L', 1, 'BK', 6),
(598, '1999-12-13 00:00:00', 'FDSK3', 1, 121, 'L', 2, 'BK', 3),
(600, '1999-12-14 00:00:00', 'ILJ878', 2, 106, 'B', 4, 'BK', 1),
(604, '1999-12-15 00:00:00', 'KFKESJK5', 1, 104, 'B', 4, 'BK', 6),
(605, '1999-12-15 00:00:00', 'SDJ89342', 1, 140, 'B', 3, 'BK', 6),
(609, '1999-12-16 00:00:00', 'KJLK89', 1, 104, 'L', 4, 'BK', 5),
(613, '1999-12-17 00:00:00', 'FD2323', 1, 104, 'L', 2, 'BK', 7),
(614, '1999-12-17 00:00:00', 'FGG66', 2, 104, 'L', 4, 'BK', 8),
(618, '1999-12-18 00:00:00', 'CMFJ39', 1, 119, 'L', 3, 'BK', 1),
(622, '1999-12-19 00:00:00', 'JJJ77', 1, 106, 'L', 1, 'BK', NULL),
(631, '1999-12-22 00:00:00', 'MM78I879', 1, 130, 'L', 4, 'BK', NULL),
(665, '2000-01-16 00:00:00', 'FDSK83', 1, 140, 'B', 2, 'BK', 2),
(676, '2000-01-18 00:00:00', 'SJK5', 1, 104, 'L', 3, 'BK', 4),
(677, '2000-01-18 00:00:00', 'KJKJ88', 1, 140, 'B', 1, 'BK', 3),
(682, '2000-01-19 00:00:00', 'GF887', 3, 140, 'G', 2, 'BK', NULL),
(709, '2000-01-25 00:00:00', 'MNHY15', 1, 104, 'L', 1, 'BK', 4),
(714, '2000-01-26 00:00:00', 'KKJ91', 1, 140, 'L', 4, 'BK', 4),
(722, '2000-01-27 00:00:00', 'FDJS32', 1, 119, 'L', 4, 'BK', 8),
(740, '2000-01-29 00:00:00', 'MNHY19', 1, 119, 'B', 1, 'BK', NULL),
(776, '2000-02-02 00:00:00', '345435F', 2, 109, 'L', 1, 'BK', 5),
(777, '2000-02-02 00:00:00', 'AS54676', 2, 143, 'B', 4, 'BK', 4),
(798, '2000-02-04 00:00:00', 'A7667900', 1, 143, 'L', 1, 'BK', NULL),
(805, '2000-02-05 00:00:00', '456546DFD', 1, 143, 'L', 2, 'BK', 5),
(826, '2000-02-20 00:00:00', '62323', 4, 128, 'G', 3, 'BK', NULL),
(827, '2000-02-20 00:00:00', 'D869990', 2, 128, 'G', 2, 'BK', 6),
(838, '2000-02-25 00:00:00', 'GFF84', 1, 141, 'B', 1, 'BK', NULL),
(852, '2000-02-29 00:00:00', 'GFF79', 1, 127, 'B', 1, 'BK', 7),
(857, '2000-03-01 00:00:00', 'SFDFSD54', 2, 127, 'B', 2, 'BK', 6),
(866, '2000-03-02 00:00:00', 'SFDFSD53', 1, 127, 'L', 1, 'BK', 9),
(876, '2000-03-03 00:00:00', 'SFDFSD55', 1, 127, 'B', 4, 'BK', 4),
(880, '2000-03-04 00:00:00', 'GFF85', 1, 141, 'B', 3, 'BK', 3),
(884, '2000-03-05 00:00:00', 'GFF86', 2, 141, 'B', 4, 'BK', NULL),
(899, '2000-03-15 00:00:00', 'QERQ1322', 2, 121, 'B', 2, 'BK', 8),
(902, '2000-03-17 00:00:00', 'D569767', 2, 121, 'B', 4, 'BK', NULL),
(910, '2000-03-19 00:00:00', 'GFF102', 1, 114, 'B', 3, 'BK', 7),
(939, '2000-03-25 00:00:00', '86431RT', 2, 120, 'B', 1, 'BK', 7),
(943, '2000-03-26 00:00:00', '34265Q67L', 2, 140, 'L', 4, 'BK', 8),
(960, '2000-03-30 00:00:00', 'GFF105', 1, 122, 'B', 1, 'BK', 4),
(973, '2000-04-01 00:00:00', 'GFF104', 2, 133, 'B', 4, 'BK', NULL),
(988, '2000-04-04 00:00:00', '76584847', 1, 139, 'L', 2, 'BK', 9),
(989, '2000-04-04 00:00:00', '4656757Q', 1, 139, 'B', 4, 'BK', 4),
(1001, '2000-04-07 00:00:00', '53165616', 2, 133, 'B', 4, 'BK', 1),
(1034, '2000-04-19 00:00:00', 'F789900', 2, 105, 'G', 1, 'BK', 3),
(1047, '2000-04-20 00:00:00', '234244S', 2, 105, 'B', 1, 'BK', 4),
(1067, '2000-04-22 00:00:00', '4325434RE', 2, 117, 'B', 1, 'BK', 6),
(1073, '2000-04-23 00:00:00', '68798890', 2, 117, 'L', 3, 'BK', 4),
(1075, '2000-04-23 00:00:00', '78755U', 2, 123, 'L', 2, 'BK', NULL),
(1089, '2000-04-24 00:00:00', 'T6657D', 2, 142, 'B', 3, 'BK', 3),
(1105, '2000-04-26 00:00:00', '53165765R', 1, 119, 'B', 2, 'BK', NULL),
(1141, '2000-05-04 00:00:00', '35653B', 1, 120, 'L', 2, 'BK', NULL),
(1165, '2000-05-25 00:00:00', 'LJJ113', 1, 127, 'L', 1, 'BK', 0),
(1178, '2000-05-30 00:00:00', 'LJJ108', 1, 118, 'B', 1, 'BK', 7),
(1187, '2000-06-14 00:00:00', 'R4777FG', 1, 143, 'L', 3, 'BK', 6),
(1192, '2000-06-28 00:00:00', 'LJJ115', 1, 109, 'B', 4, 'BK', 9),
(1194, '2000-06-29 00:00:00', 'LJJ114', 1, 141, 'B', 2, 'BK', 4),
(1202, '2000-07-14 00:00:00', 'LJJ126', 1, 135, 'B', 1, 'BK', 3),
(1206, '2000-07-15 00:00:00', 'LJJ131', 1, 121, 'B', 2, 'BK', NULL),
(1207, '2000-07-15 00:00:00', 'FJS3492', 2, 135, 'L', 1, 'BK', 8),
(1228, '2000-08-01 00:00:00', 'LJJ120', 1, 106, 'B', 3, 'BK', NULL),
(1230, '2000-08-03 00:00:00', 'LJJ121', 1, 107, 'B', 1, 'BK', 7),
(1240, '2000-08-14 00:00:00', 'FSDFJ357', 1, 127, 'B', 4, 'BK', 4),
(1248, '2000-08-17 00:00:00', 'FSDFJ358', 1, 141, 'L', 4, 'BK', NULL),
(1251, '2000-09-09 00:00:00', 'FSDFJ349', 1, 130, 'B', 2, 'BK', 4),
(1254, '2000-09-12 00:00:00', 'KJFKD89', 1, 130, 'L', 3, 'BK', 3),
(1270, '2000-10-17 00:00:00', 'FSD82937', 1, 130, 'B', 1, 'BK', NULL),
(1293, '2000-10-22 00:00:00', 'KJLK89234', 1, 130, 'L', 2, 'BK', NULL),
(1301, '2000-11-21 00:00:00', 'FSD82940', 1, 127, 'B', 1, 'BK', NULL),
(1302, '2000-11-22 00:00:00', 'FSD82941', 1, 141, 'B', 4, 'BK', 6),
(1303, '2000-11-23 00:00:00', 'KJk934', 1, 127, 'B', 3, 'BK', 5),
(1305, '2000-11-12 23:59:59', 'test2', 2, 104, 'B', 2, 'BK', NULL),
(1334, '2000-11-11 00:00:00', 'TEST', 1, 118, 'G', 4, 'BK', NULL);
...
(104, 'Laetia', 'Enison', '144-61 87th Ave, NE', 'Edmonton', 'AB', 'T2J 6B6', 'Canada', '4032791223', '4032557865', 'LEnison@gmail.com', 'password', 4),
(105, 'Angel', 'Moskowitz', '320 John St., NE', 'Calgary', 'AB', 'T2J 7E3', 'Canada', '4032794228', '4036409874', 'amoskowitz@home.com                               ', 'password', 3),
(106, 'Judith', 'Olvsade', '29 Elmwood Ave.,', 'Calgary', 'AB', 'T2Z 3M9', 'Canada', '4032795652', '4036861598', 'jolvsade@aol.com                                  ', 'password', 1),
(107, 'Catherine', 'Mierzwa', '22-70 41st St.,NW', 'Calgary', 'AB', 'T2Z 2Z9', 'Canada', '4032796878', '4036404563', 'cmierzwa@msn.com                                  ', 'password', 4),
(108, 'Judy', 'Sethi', '63 Stratton Hall, SW', 'Calgary', 'AB', 'T1Y 6N4', 'Canada', '4032795111', '4036204789', 'judysehti@home.com                                ', 'password', 7),
(109, 'Larry', 'Walter', '38 Bay 26th ST. #2A, NE', 'Calgary', 'AB', 'T2J 6B6', 'Canada', '4032793254', '4032845588', 'lwalter@aol.com                                   ', 'password', 4),
(114, 'Winsome', 'Laporte', '268 E.3rd St, SW', 'Calgary', 'AB', 'T1Y 6N4', 'Canada', '4032691125', '4032844565', 'WLaporte@gmail.com', 'password', 8),
(117, 'Nancy', 'Kuehn', '44-255 9th St., SW', 'Calgary', 'AB', 'T1Y 6N5', 'Canada', '4032693965', '4032843211', 'NKuehn@gmail.com', 'password', 6),
(118, 'Hiedi', 'Lopez', '168 Rowayton Ave, NW', 'Calgary', 'AB', 'T3A 4ZG', 'Canada', '4032699856', '4035901587', 'hlopez@aol.com                                    ', 'password', 4),
(119, 'Mardig', 'Abdou', '160-04 32nd Ave., SW', 'Calgary', 'AB', 'T2P 2G7', 'Canada', '4032691429', '4032251952', 'MAbdou@gmail.com', 'password', 9),
(120, 'Ralph', 'Alexander', '2054 73rd St, SW', 'Calgary', 'AB', 'T2P 2G7', 'Canada', '4032691634', '4032256547', 'RAlexander@gmail.com', 'password', 1),
(121, 'Sean', 'Pineda', '3 Salem Rd., NW', 'Calgary', 'AB', 'T2K 3E3', 'Canada', '4032691954', '4036864444', 'spineda@hotmail.com                               ', 'password', 3),
(122, 'Julita', 'Lippen', '51-76 VanKleeck St., NW', 'Calgary', 'AB', 'T2K 6C5', 'Canada', '4032551956', '4035901478', 'jlippen@cadvision.co                              ', 'password', 4),
(123, 'Pierre', 'Radicola', '322 Atkins Ave., SE', 'Calgary', 'AB', 'T3G 2C6', 'Canada', '4032551677', '4036867536', 'pradicola@home.com                                ', 'password', 8),
(127, 'Gary', 'Aung', '135-32 Louis Blvd, NE', 'Calgary', 'AB', 'T2V 2K5', 'Canada', '4032807858', '4037501587', 'GAung@gmail.com', 'password', 9),
(128, 'Jeff', 'Runyan', '109-15 Queens Blvd., NE', 'Calgary', 'AB', 'T2V 2K6', 'Canada', '4032809635', '4036201122', 'jrunyan@aol.com                                   ', 'password', 4),
(130, 'Lula', 'Oates', '11A Emory St., NE', 'Calgary', 'AB', 'T3E 3Z4', 'Canada', '4032439653', '4036861587', 'loates@aol.com                                    ', 'password', 9),
(133, 'James', 'Reed', '109-621 96th St, NE', 'Calgary', 'AB', 'T3E 4A1', 'Canada', '4032432358', '4037201155', 'jreed@aol.com                                     ', 'password', 2),
(135, 'Michellexxxxxxxxxxxxxx', 'Masser', '379 Ovington Ave, NE', 'Calgary', 'AB', 'T2J 2S9', 'Canada', '4032441586', '4035908522', 'mmasser@aol.com                                   ', 'password', 6),
(138, 'John', 'Smith', '45 Plaza St. West #2D, NE', 'Calgary', 'AB', 'T3E 5C7', 'Canada', '4032449653', '4032837896', 'johnSmith@hotmail.co                              ', 'password', 7),
(139, 'Angelo', 'Garshman', '82 Western Ave., NE', 'Calgary', 'AB', 'T3E 5C8', 'Canada', '4032259966', '4032696541', 'AGarshman@gmail.com', 'password', 3),
(140, 'Derrick', 'Baltazar', '9111 Church Ave. #3N, NE', 'Calgary', 'AB', 'T3E 5C9', 'Canada', '4032255231', '4037502547', 'DBaltazar@gmail.com', 'password', 6),
(141, 'Robert', 'Boyd', '96-04 57th Ave #12A, NE', 'Calgary', 'AB', 'T3E 5C5', 'Canada', '4032255647', '4037509512', 'RBoyd@gmail.com', 'password', 3),
(142, 'Monica', 'Waldman', '257 Depot Rd., NE', 'Calgary', 'AB', 'T2J 6P3', 'Canada', '4032255629', '4032844566', 'mwaldman@aol.com                                  ', 'password', 2),
(143, 'Gerard', 'Biers', '205 19th St., NE', 'Calgary', 'AB', 'T2J 6B6', 'Canada', '4032251952', '4037506578', 'GBiers@gmail.com', 'password', 8),
(144, 'z', 'z', 'z', 'z', 'Z', 'Z1Z1Z1', 'z', '5555555555', '2222222222', 'z@z.zz', 'password', 1);
...
--
ALTER TABLE `bookings`
  MODIFY `BookingId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1335;
...
ALTER TABLE `packages_products_suppliers`
  ...
  ADD CONSTRAINT `packages_products_suppliers_ibfk_2` FOREIGN KEY (`PackageId`) REFERENCES `packages` (`PackageId`) ON DELETE CASCADE ON UPDATE CASCADE;
